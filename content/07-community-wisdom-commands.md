...
Diggy suggested turning great mining advice into bot commands so volunteers can answer common questions without rewriting the same explanation every time.

This is the MonkeDAO-style pattern: preserve answers, make them easy to summon, and turn chat into an onboarding engine. Great advice shouldn't get buried in Discord scroll.
...
Beginner-safe accumulation strategy: small size, all tiles, long time horizon.

> Mine with all 25 tiles. Check ore.fyi production cost before every session. If it costs more to mine than to buy, don't mine. Keep your miner small. Be consistent. Be patient. This isn't a sprint.

### !gambling

Explains that fewer tiles means higher variance. It can be fun, but it is not the same thing as conservative mining.

### !uore

Explains unrefined ORE, claim fees, patience, and why long-term holders care about yield.

> Don't claim your uORE. It earns ~70-75% APR just sitting there. Claiming costs a 10% fee. Patient holders absorb the fees that impatient claimers pay. The longer you hold, the more you earn.

### !safe

Warns about overdeployment and misconfiguration. Start small. Set caps. Understand the numbers before increasing size.

> Before you mine: set your tile count to 25, set a SOL budget you can afford to lose, and understand every setting before you click start. Misconfigured miners can blow all your SOL in one round.

### !noclaim

Community consensus on claiming:

> If you must claim, wait at least 1.5 months so the yield offsets the fee. Use multiple wallets — claim from one while the others keep compounding yield.
...
Miners framed a 250 uORE stack as a meaningful psychological milestone while tying patience to future protocol mechanics, especially partial claims. The public takeaway is not a price target; it is the importance of knowing which conditions would justify claiming versus continuing to hold.
